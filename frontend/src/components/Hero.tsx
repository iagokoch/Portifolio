...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-br from-black via-blue-950 to-black pt-24"
    >
      {/* Background orbs */}
      <motion.div
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <a
            ...
            target="_blank"
            className="p-3 rounded-full bg-slate-900/80 text-slate-300 hover:text-blue-400 hover:bg-slate-900 transition-colors"
          >
