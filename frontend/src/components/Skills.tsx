...
function Skills() {
  return (
    <section
      id="skills"
      className="py-24 px-6 bg-linear-to-b from-black to-slate-950"
    >
          ...
          {skills.map((skill, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`relative mb-4 w-12 h-12 rounded-xl bg-linear-to-br ${skill.color} p-2.5 group-hover:scale-110 transition-transform`}
                >
                ...
                <ul className="relative space-y-2">
                  {skill.items.map((item) => (
                    ...
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full bg-linear-to-r ${skill.color}`}
                      />
                      {item}
                    </li>
                  ))}
                ...
                {/* Decorative corner */}
                <div
                  className={`absolute top-0 right-0 w-20 h-20 bg-linear-to-br ${skill.color} opacity-5 blur-2xl`}
                />
              </motion.div>
            );
          })}
